...
const Servey = () => {
  return (
    <div className="bg-gradient-to-r from-teal-100 to-teal-400 opacity-75 max-w-7xl mx-auto rounded-md text-center flex gap-4 justify-around lg:justify-center lg:gap-12 flex-wrap px-3  pt-8 pb-8 mt-8">
