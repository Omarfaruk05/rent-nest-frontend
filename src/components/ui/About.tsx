      ...
      <div className="grid md:grid-cols-2 gap-4 justify-center md:items-center mx-3 mt-12">
        <div>
          ...
          <p className="text-slate-500 lg:text-xl mb-4">
            Starting back in 2016, Rent Nest has now become the only real estate
            ...
            with our incomparable database of information, Rent Nest has become
          ...
          <p className="text-slate-500 lg:text-xl">
            ...
            solutions are under one roof. Rent Nest utilizes technology to drive
